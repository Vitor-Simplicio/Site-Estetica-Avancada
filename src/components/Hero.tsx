  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/10" /> {/* Filtro mais claro para melhor visibilidade do texto escuro */}
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="flex flex-col items-center text-center gap-8 animate-reveal">
          <div className="max-w-4xl">
            <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 leading-tight text-foreground tracking-tight text-shadow-premium">
              Beleza que <span className="text-primary">transforma</span>, cuidado que encanta!
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-foreground/80 mb-10 leading-relaxed max-w-2xl mx-auto font-light text-shadow-premium">
